...
// DEPRECATED: Another OpenAI Vision variant - consolidated into /api/v1/receipt-ocr
...
export async function GET() {
  return Response.json({
    deprecated: true,
    message: "This vision OCR endpoint has been consolidated into /api/v1/receipt-ocr",
