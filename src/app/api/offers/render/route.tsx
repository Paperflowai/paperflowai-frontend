...
export async function POST(req: NextRequest) {
  try {
    ...
    return new Response(buf, {
      status: 200,
      headers: { "Content-Type": "application/pdf", "Content-Disposition": "inline; filename=offert.pdf" },
    });
  } catch (e: any) {
    return new Response(JSON.stringify({ ok:false, error: e?.message || "Render-fel" }), { status: 500 });
  }
}
