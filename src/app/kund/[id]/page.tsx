...
export default function KundDetaljsida() {
  ...
  return (
    <div className="min-h-screen bg-white p-6 text-gray-800 max-w-4xl mx-auto">
      ...
      {/* Liten "nästa" knapp till bokföring */}
      <div className="mb-2">
        <button
          onClick={() => { window.location.assign('/dashboard/bookkeepingboard'); }}
          className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded bg-black/60 text-white"
          title="Gå till bokföring"
        >
          Till bokföringen
        </button>
      </div>
